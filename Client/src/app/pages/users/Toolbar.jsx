...
export function Toolbar({ table, onCreateUser, canCreate = true }) {
    ...
    <div className="table-toolbar">
      <div
        className={clsx(
          ...
          isFullScreenEnabled ? "px-4 sm:px-5 pt-4" : "px-(--margin-x) pt-4",
        )}
      >
        ...
        {isXs ? (
          <div className="flex items-center gap-2">
            {onCreateUser && canCreate && (
              <Button
                onClick={onCreateUser}
                color="primary"
                size="sm"
                className="h-7 space-x-1.5 rounded-md px-2.5 text-xs font-medium shrink-0"
              >
        ...
        <>
          ...
          >
            {table.getColumn("role") && (
              <RoleFilter column={table.getColumn("role")} />
            )}
          </div>
        </>
      ) : (
